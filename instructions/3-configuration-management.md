...
- Find the job named `smoke-test` in your config file.
  ...
  - Write code to make a simple test on both front-end and back-end. Use the suggested tests below or come up with your own. 
    ...
    - Test the front-end
      - Form the front-end url using the workflow id and your AWS region like this: `URL="http://udapeople-${CIRCLE_WORKFLOW_ID}.s3-website-ap-southeast-1.amazonaws.com"` 
